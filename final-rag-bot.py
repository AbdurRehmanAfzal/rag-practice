...
# ============================================
# System Prompt — Guardrails ke sath
# ============================================
...
# ============================================
# NAYA: Core Logic — ek function mein, taake /ask aur evaluation dono use kar sakein
# ============================================

def process_question(question: str, session_id: str | None = None):
    """Poora RAG pipeline: guardrail -> retrieval -> generation -> lead extraction"""
...
def ask_question(request: QuestionRequest):
    return process_question(request.question, request.session_id)

# ============================================
# NAYA: RAG Evaluation — Simple Keyword-Based Test Set
# ============================================

test_cases = [
    {
        "question": "What is his tech stack?",
        "expected_keywords": ["Django", "FastAPI", "React"]
    },
    {
        "question": "Where did he study?",
        "expected_keywords": ["University of Central Punjab", "Computer Science"]
    },
    {
        "question": "What is his experience with RAG?",
        "expected_keywords": ["LangChain", "RAG", "ChromaDB"]
    }
]


def run_evaluation(cases: list):
    """Har test case ko chalata hai aur expected keywords ke against score deta hai"""
    results = []
    for test in cases:
        response = process_question(test["question"], session_id=None)
        answer = response["answer"]

        found = sum(1 for kw in test["expected_keywords"] if kw.lower() in answer.lower())
...
@app.get("/evaluate")
def evaluate():
    """Yeh endpoint hamare pre-defined test_cases ko chalata hai aur scores deta hai.
    Browser mein http://127.0.0.1:8000/evaluate khol kar dekha ja sakta hai."""
